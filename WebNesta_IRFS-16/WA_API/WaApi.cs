...
using WebNesta_IRFS_16.WA_API.Helpers;

namespace WebNesta_IRFS_16.WA_API
{
    public class WaApi
    {
        /// <summary>
        ...
        /// </summary>
        private string APIUrl = ConfigurationManager.AppSettings["CHAT-API_URL"];
        /// <summary>
        /// Token. You can get it in your personal office.
        /// </summary>
        private string token = ConfigurationManager.AppSettings["CHAT-API_TOKEN"];
        ...
        //}
        public async Task<string> SendMessage(string phone, string text)
        {
            var data = new Dictionary<string, string>()
            {
                {"phone",phone },
        ...
        public async Task<string> SendWhats(string to, string body)
        {
